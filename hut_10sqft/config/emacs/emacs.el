...
; 2019/10/09 Macro to convert a Gitlab http URL of an issue on any %ORG% repo to link format in .md.
...
; 2019/10/09 Macro to convert a Gitlab http URL of an issue on any %ORG% repo to link format in .rst.
