...
# Random tools
PKG_RANDOM_TOOLS="ack-grep aptitude dconf-editor gnome-tweak-tool googleearth-package gtk-recordmydesktop indicator-multiload nmap pdftk pidgin psensor ptex-base ssh sysinfo synaptic texlive-latex-base tmux tree whois"
